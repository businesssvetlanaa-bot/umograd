...
Пока в БД нет уникального ограничения на тип постройки ребёнка, запускайте SQLite-приложение ровно в одном процессе/реплике: защита от повторной покупки между процессами появится только после отдельной миграции.
